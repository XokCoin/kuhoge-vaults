...
// File: contracts/BIFI/strategies/kus/StrategykusbusdLP.sol
...
contract StrategykusbusdLP is StratManager, FeeManager, GasThrottler {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;

    // Tokens used
    address constant public wbnb = address(0x4446Fc4eb47f2f6586f9fAAb68B3498F86C07521);
    address constant public busd = address(0xe3f5a90f9cb311505cd691a46596599aa1a0ad7d);
    ...
    constructor(
        ...
        if (lpToken0 == busd) {
            kusToLp0Route = [kus, wbnb, busd];
        } else if (lpToken0 != kus) {
            kusToLp0Route = [kus, wbnb, busd, lpToken0];
        }

        if (lpToken1 == busd) {
            kusToLp1Route = [kus, wbnb, busd];
        } else if (lpToken1 != kus) {
            kusToLp1Route = [kus, wbnb, busd, lpToken1];
        }
