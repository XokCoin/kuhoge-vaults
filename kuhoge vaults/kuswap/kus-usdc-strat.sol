...
// File: contracts/BIFI/strategies/kus/StrategykususdcLP.sol
...
contract StrategykususdcLP is StratManager, FeeManager, GasThrottler {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;

    // Tokens used
    address constant public wbnb = address(0x4446Fc4eb47f2f6586f9fAAb68B3498F86C07521);
    address constant public usdc = address(0x980a5afef3d17ad98635f6c5aebcbaeded3c3430);
    ...
    constructor(
        ...
        if (lpToken0 == usdc) {
            kusToLp0Route = [kus, wbnb, usdc];
        } else if (lpToken0 != kus) {
            kusToLp0Route = [kus, wbnb, usdc, lpToken0];
        }

        if (lpToken1 == usdc) {
            kusToLp1Route = [kus, wbnb, usdc];
        } else if (lpToken1 != kus) {
            kusToLp1Route = [kus, wbnb, usdc, lpToken1];
        }
