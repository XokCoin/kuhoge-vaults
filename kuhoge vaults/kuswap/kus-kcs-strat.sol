...
// File: contracts/BIFI/strategies/kus/StrategykusLP.sol
...
contract StrategykusLP is StratManager, FeeManager, GasThrottler {
    ...
    constructor(
        ...
        if (lpToken0 == wbnb) {
            kusToLp0Route = [kus, wbnb];
        } else if (lpToken0 != kus) {
            kusToLp0Route = [kus, wbnb, lpToken0];
        }

        if (lpToken1 == wbnb) {
            kusToLp1Route = [kus, wbnb];
        } else if (lpToken1 != kus) {
            kusToLp1Route = [kus, wbnb, lpToken1];
        }
