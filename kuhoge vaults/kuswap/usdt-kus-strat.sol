...
// File: contracts/BIFI/strategies/kus/StrategykususdtLP.sol
...
contract StrategykususdtLP is StratManager, FeeManager, GasThrottler {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;

    // Tokens used
    address constant public wbnb = address(0x4446Fc4eb47f2f6586f9fAAb68B3498F86C07521);
    address constant public usdt = address(0x0039f574ee5cc39bdd162e9a88e3eb1f111baf48);
    ...
    constructor(
        ...
        if (lpToken0 == usdt) {
            kusToLp0Route = [kus, wbnb, usdt];
        } else if (lpToken0 != kus) {
            kusToLp0Route = [kus, wbnb, usdt, lpToken0];
        }

        if (lpToken1 == usdt) {
            kusToLp1Route = [kus, wbnb, usdt];
        } else if (lpToken1 != kus) {
            kusToLp1Route = [kus, wbnb, usdt, lpToken1];
        }
